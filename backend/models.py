...
class FactCheckResult:
    ...
    operationalization: str | None = None  # what would confirm/refute
...
class DebateFrame:
    ...
    framing_debate_id: str | None = None
    is_active: bool = True
...
class Debate:
    ...
    active_frame: DebateFrame | None = None
    user_id: str | None = None  # Creator of the debate
