...
class TemporalContext:
    ...
    expiration_policy: str | None = None  # "NEVER", "30_DAYS", "90_DAYS", "1_YEAR"
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "temporal_context": {
                ...
                "observation_date": self.temporal_context.observation_date.isoformat()
                if self.temporal_context and self.temporal_context.observation_date
                else None,
                "expiration_policy": self.temporal_context.expiration_policy
...
class ApprovedSource:
    ...
    source_id: str
    domain: str
    endpoint: str | None  # Exact endpoint if applicable
...
class AllowlistVersion:
    ...
    def get_source_for_url(self, url: str) -> ApprovedSource | None:
