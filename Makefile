...
.PHONY: help bootstrap status resume review-prompts check unit fact smoke e2e server server-v1 server-fast manual-ai manual-energy modulation openrouter-setup executor-bootstrap
