...
def engine():
    ...
    e.scoring_engine.run_replicates.return_value = [
        ReplicateResult(overall_for=0.6, overall_against=0.4, margin_d=0.2,
                        topic_scores={}, overall_scores={}, side_order=["FOR", "AGAINST"], metadata={})
    ]
    e.scoring_engine.compute_debate_scores.return_value = {
        "overall_for": 0.6, "overall_against": 0.4, "margin_d": 0.2,
        "topic_scores": {}, "overall_scores": {}
    }
    e.scoring_engine.compute_verdict.return_value = {
        "verdict": "FOR", "ci_lower": 0.1, "ci_upper": 0.3, "confidence": 0.9,
    }
...
def test_replicate_stage(engine):
    ctx = PipelineContext(
        ...
        scores={"overall_for": 0.6, "overall_against": 0.4, "margin_d": 0.2, "topic_scores": {}, "overall_scores": {}},
    )
